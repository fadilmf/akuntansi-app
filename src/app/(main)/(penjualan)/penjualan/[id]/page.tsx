...
export default function DetailPenjualanPage() {
  ...
  const fetchData = async (id: number) => {
    ...
    try {
      ...
      setTitle(`Detail - ${formData.invoiceNumber}`);
            ...
            <div className="flex mb-10">
              <AlertDialog>
                <AlertDialogTrigger asChild>
                  <Button variant={"destructive"}>Hapus Invoice</Button>
                </AlertDialogTrigger>
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>
                      Apakah kamu mau menghapus invoice {form.invoiceNumber}?
                    </AlertDialogTitle>
                    <AlertDialogDescription>
                      Data akan dihapus secara permanen dan tidak bisa
                      dikembalikan.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
